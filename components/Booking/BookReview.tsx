        ...
        <div className=' grid gap-4'>
            <div className=' flex items-center gap-2 my-2'>
                <div className=' flex items-center'>
                    <h2 className=' text-sm font-semibold'>Mumbai</h2>
                    <ArrowRight className='w-4 h-4 text-foreground mx-1'/>
                    <h2 className='text-sm font-semibold'>Delhi</h2>

                </div>
                <p className='  text-sm font-light'>Mon, 26 Feb 2024</p>
            ...
            <div className=' flex items-center gap-4 mb-5'>
                <div>
                    ...
                    <p className='w-20 text-xs text-foreground'>Air India Express IX-2903 Economy</p>
                </div>
                <div className='grid gap-4'>
                    <div className=' flex items-center gap-2'>
                        <p className=' font-semibold text-2xl text-black'>23:20</p>
                        <p className=' text-lg text-foreground '>BLR</p>
                        <p className=' text-xs text-foreground'>Kempegowda International Airport, Bangalore, Terminal 2</p>
                    </div>
                    <Clock5 className=' w-4 h-5 text-foreground'/>
                    <div className=' flex items-center gap-2'>
                        <p className=' font-semibold text-2xl text-black'>01:05</p>
                        <p className=' text-lg text-foreground '>BOM</p>
                        <p className=' text-xs text-foreground'>Chatrapati Shivaji Airport, Mumbai, Terminal 2</p>
                    </div>
                </div>
            </div>
            <div className=' grid items-center'>
                <div className="border-b border-gray-300 bg-blue-100 p-4">
                    <div className=' flex items-center gap-2'>
                        <h1 className=' text-sm font-bold'>BLR</h1>
